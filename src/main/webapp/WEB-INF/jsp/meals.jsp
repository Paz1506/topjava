...
<section>
    ...
    <form id="filterForm" method="post" action="meals/filter">
        ...
        <button class="btn btn-success" onclick="filterMeal()">
            <span class="fa fa-filter"></span>
            <spring:message code="meal.filter"/>
        </button>
        <button class="btn btn-warning" onclick="resetFilter()">
            <span class="fa fa-times"></span>
            <spring:message code="meal.clean_filter"/>
        </button>
    </form>
    <hr>
    ...
    <hr>
    <table class="table table-striped" id="mealDatatable" border="1" cellpadding="8" cellspacing="0">
        <thead>
        <tr>
...
<%--Блок добавления новой еды--%>
<div class="modal fade" tabindex="-1" id="addMealModal">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="detailsForm">
                    <input type="hidden" id="id" name="meal_id">
